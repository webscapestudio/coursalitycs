        ...
        <div className={s.inner}>
          <div className="container">
            <div className={s.left}>
              ...
              <Link href="https://coursalytics.com/experts-catalog">
                <a>
            ...
            <div className={s.right}>
              ...
              <div className={cn(s.item, s.item__card)}>
                ...
                <p>
                  Adjunct faculty member at <br /> National University of
                  Singapore
                </p>
              </div>
              ...
              <div className={cn(s.item, s.item__card)}>
                ...
                <p>
                  Independent Project <br /> Management Expert at Vlerick <br />{" "}
                  Business School
                </p>
              </div>
              ...
              <div className={cn(s.item, s.item__card)}>
                ...
                <p>
                  Associate Professor of <br /> Organizational Behavior at{" "}
                  <br /> ESMT Berlin
                </p>
              </div>
